...
# board.bin file is from: https://www.killernetworking.com/support/K1535_Debian/board.bin
...
then
    ...
    if [[ $input == 'y' || $input == 'Y' ]]
    then
        wget https://www.killernetworking.com/support/K1535_Debian/board.bin -P ~/Downloads/
        ...
        echo "Download link: https://www.killernetworking.com/support/K1535_Debian/board.bin "
    fi    
fi
echo "Done!" 
sudo shutdown -P now